...
class DefaultController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
                    ...
                    if ($membership->getRegistrations()->count() <= 0) {
                        ...
                        if ($remainingDays < 0)
                            ...
                            $session->getFlashBag()->add('warning',
                                ...
                                'Tu peux ré-adhérer en ligne par carte bancaire ou bien au bureau des membres par chèque, virement ou ' .
        ...
        $dynamicContentEntity = $em->getRepository('AppBundle:DynamicContent')->findOneByCode("HOME");
